  ...
  return (
    <main className='w-full px-9 pb-9 flex flex-col gap-9 relative'>
      <div className='flex flex-col gap-9 sticky top-[4.7rem] z-10 bg-[#f8f9fa]'>
        <h1 className='font-bold text-2xl text-[#18181B] py-2 sticky top-[76px] bg-[#F8F9FA] z-40'>Custom Label</h1>
        <div>
          <ul className='list-none flex gap-6 font-semibold'>
            <li style={{ cursor: 'pointer', fontSize: '14px' }} className={selectedLi === 0 ? 'text-[var(--primary-color)] ' : 'text-[#A0AEC0]'} onClick={() => handleLiClick(0)}>Label Preference</li>
          </ul>

...
const Page = () => {
    ...
    return (
        <main className="w-full px-4 bg-[#f9fafb] flex flex-col gap-2">
            <h1 className='font-bold text-2xl text-[#18181B]'>Volumetric Weight Calculator</h1>
            <div className='rounded-xl bg-white p-4 flex flex-col gap-10'>
                <form onSubmit={handleSubmit(onSubmit)} className='flex justify-between items-center '>
                    {/* Inputs */}
                    <div className='flex flex-col gap-10'>
                        {['Length', 'Width', 'Height'].map((dimension) => (
                            <div key={dimension} className='flex items-center border-2 border-gray-300 rounded-lg'>
                                <input
                                    type='number'
                                ...
                                />
                                <span className='p-3 bg-[#F3F7FE] text-xs text-[#979797] rounded-r-lg'>cm</span>
                            </div>
                        ))}
                    </div>
                    ...
                    <div className='flex flex-col gap-4'>
                        <button type='submit' className='bg-[#EA2147] text-white py-2 px-10 rounded-md'>Calculate</button>
                        <button type='button' onClick={handleReset} className='border border-[#EA2147] text-[#EA2147] py-2 px-10 rounded'>Reset</button>
                    </div>
                ...
                <div className='text-[#C3B600] bg-[#FBF3E0] p-4 border-2 border-[#C3B600] rounded-md flex flex-col gap-3'>
                    ...
                    <p className='text-[10px]'>
                        It helps us know the space your package will occupy in the container.
                    </p>
                </div>
            </div>
        </main>

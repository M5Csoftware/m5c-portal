...
const Account = () => {
  ...
  // -----------------------------------
  // FETCH ACCOUNT LEDGER FROM NEW GET ROUTE
  // -----------------------------------
  useEffect(() => {
    const fetchLedger = async () => {
      ...
      try {
        const url = `${server}/ledger?accountCode=${session.user.accountCode}`;
        ...
        console.error("Error fetching ledger:", error.response?.data || error.message);
      }
    };
            ...
            <ul className="list-none flex gap-6">
              {["All", "Hold Shipment", "RTO"].map((tab, i) => (
                <li
                  ...
                  className={
                    selectedLi === i ? "text-[var(--primary-color)]" : "text-[#A0AEC0]"
                  }
        ...
        <div className="flex">
          ...
          >
            <div className="flex gap-4">
              <Image width={20} height={20} src="/arrow-right.svg" alt="download_all" className="rotate-90" />
          ...
          <div className="flex gap-4">
            ...
            <div className="flex gap-3 relative">
              ...
              >
                ...
                <Image width={20} height={20} src="/calendar.svg" alt="calendar" />
              </button>

              {showDatePicker && (
                <div ref={datePickerRef} className="absolute z-50 top-full left-0 mt-2 bg-white shadow-lg border">
                  <DateRangePicker
                    ranges={dateRange}

 ...
 */
export const exportShipmentsToExcel = async (shipments, fileName = 'Shipment_Overview.xlsx') => {
    ...
    shipments.forEach((shipment) => {
        const row = worksheet.addRow({
            ...
            date: shipment.date ? new Date(shipment.date).toLocaleDateString('en-IN') : '--',
            ...
            content: shipment.content || shipment.goodstype || '--',
            pcs: shipment.pcs || 0,

...
export function TableWithSorting({
  ...
  return (
    <div className="h-64 w-full overflow-x-auto table-scrollbar rounded-lg border border-battleship-gray text-xs">
          ...
          >
            <div className="flex items-center gap-2">
              ...
              <span className="text-xs text-gray-500 hover:text-black">
                {sortKey === column.key && (
                  <div
                    className={`${sortOrder === "asc" ? "rotate-180" : ""} w-4 h-4`}
                  >
                    <Image
  ...
  return (
    <tr className="border-b h-11">
      {columns.map((column, index) => (
        <td
          key={index}
          className={`px-4 py-2 text-eerie-black text-center break-words ${
            index !== columns.length - 1 ? "border-r" : "border-r"
          }`}
        >
          <span>
      ...
      <td className="text-center">
        <div className="flex items-center justify-center gap-2">
          ...
          <button
            ...
            title="Delete item"
          >
            <Image src="/addDelete.svg" alt="Delete" width={16} height={16} />
          </button>
        </div>
      </td>
    </tr>
